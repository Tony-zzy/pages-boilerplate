...
let knownOptions = {
    ...
    default: {
        ...
        production: false,
        prod: false,
        baseUrl:production?[ config.build.dist]:[config.build.temp, config.build.dist, config.build.public]
    }
};
...
const serve = () => {
    ...
    bs.init({
        ...
        // files: "dist/**",
        server: {
            baseDir: options.baseUrl,//[config.build.temp, config.build.dist, config.build.public],
            routes: {
